...
<h1>Инструкция по заполнению онлайн портфолио</h1>
<a href="/site/getmanual" target="_blank" class="btn btn-success btn-sm"><i class="glyphicon glyphicon-file"></i> Скачать инструкцию в pdf</a>
<div>&nbsp;</div>
<p>
	1. Для работы с портфолио необходимо зайти на сайт <a href="//<?=Yii::$app->university->model->subdomain?>.studentsonline.ru" target="_blank" title="Откроется в новом окне"><i class="glyphicon glyphicon-share"></i> <?=Yii::$app->university->model->subdomain?>.studentsonline.ru</a>, кликнуть в правом верхнем углу ссылку
	«войти» и ввести свой логин и пароль и перейти в личный кабинет.
</p>
<p>
	2. В всплывающем окне следует вести адрес электронной почты. Адрес необходим для восстановления пароля и передачи
...
<p>
	...
	деятельность» заполняются в том случае, если у студента есть успехи и достижения в этих областях<span class="text-info">*</span>. Желательно
