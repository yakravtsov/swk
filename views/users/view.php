...
<div class="user-view">
	...
	<? if ($role_id == User::ROLE_ADMINISTRATOR) { ?>
		...
		<!--<div class="row">
			<div class="col-xs-2">
				<a href="#" class="btn btn-link navbar-btn"><i class="glyphicon glyphicon-user"></i> Общая информация</a>
			</div>
			<div class="col-xs-8 pull-right">
						...
						<ul class="nav nav-pills">
							...
							foreach ($disciplines as $d) {
								*/?>
								<li class=""><a href="#" class=""><?/*=$d*/?></a></li>
								<!--<a href="#" class="btn btn-link navbar-btn"><?/*/*=$d*/?></a>
							<?/*
							}
							*/?>
						</ul>
			...
			<div class="container-fluid">
				...
				if ($role_id == User::ROLE_STUDENT) {
					?>
						...
						<?= Html::a(Html::tag('i', '', ['class' => 'glyphicon glyphicon-pencil']) . ' Редактировать', ['update',
						                                                                                               'id' => $model->user_id], ['class' => 'btn btn-primary btn-sm navbar-btn']) ?>
				...
				foreach ($disciplines as $key => $d) {
					?>
					<li class=""><a href="/works/studentworks?id=<?=$model->user_id?>&discipline_id=<?=$key?>" class=""><?=$d?></a></li>
